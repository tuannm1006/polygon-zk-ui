...
export const SearchInput: FC<SearchProps> = ({ value, onChange }) => {
  ...
  return (
    <>
      <div className="relative min-w-[420px] octan-search-input">
        <div className="h-[42px] rounded-[8px] flex items-center search-input">
          {/* <svg
            className="mx-[9px]"
            width="24"
            height="24"
          ...
          <input
            className="border-0 outline-0 flex-1 bg-transparent text-[16px] font-normal leading-[26px] text-[#B6B6B6]"
            placeholder="Search"
            value={text}
          ...
          {text.length > 0 && (
            <svg
              ...
              className="mx-[9px] octan-clear-input"
              width="24"
              height="24"
              viewBox="0 0 24 24"
              fill="none"
